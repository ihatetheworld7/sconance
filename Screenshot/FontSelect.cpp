	...
	m_isUnderlineClick{false}
{
	...
	fontComboBox->setStyleSheet("QComboBox{border:1px solid #E6E6E6 ; color:black;padding-right: 0px;font-family:Microsoft YaHei}\
		...
		QComboBox:down-arrow{width:16px;height:16px;image:url(:/LLOAWanZhanDemo/Resources/clickxiala.png);}\
		QComboBox:down-arrow:pressed{image: url(:/LLOAWanZhanDemo/Resources/xiala.png);}\
	...
	sizeComboBox->setStyleSheet("QComboBox{border:1px solid #E6E6E6 ;border-radius: 5px; color:black;padding-right: 0px;font-family:Microsoft YaHei;font-size:12px}\
	...
	boldBtn->setIcon(QIcon(":/LLOAWanZhanDemo/Resources/bold.png"));
	...
	italicBtn->setIcon(QIcon(":/LLOAWanZhanDemo/Resources/italicBtn.png"));
	...
	underlineBtn->setIcon(QIcon(":/LLOAWanZhanDemo/Resources/underlineBtn.png"));
	//underlineBtn->setCheckable(true);
	colorBtn = new QToolButton;
	colorBtn->setCursor(QCursor(Qt::PointingHandCursor));
	colorBtn->setAutoRaise(true);
	colorBtn->setFixedSize(32, 32);
	colorBtn->setIcon(QIcon(":/LLOAWanZhanDemo/Resources/colorBtn.png"));
